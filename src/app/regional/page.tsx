...
export default function RegionalPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="mb-12 overflow-hidden rounded-xl bg-gradient-to-r from-brand-primary to-brand-primary-dark p-8 text-white sm:p-12">
        ...
        <button className="mt-6 rounded-md bg-white px-6 py-3 text-sm font-semibold text-brand-primary transition-colors hover:bg-gray-100">
          {hero.ctaText}
        </button>
      </section>
